  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-[96rem] px-4 py-10 sm:px-6">
      <div className="mb-6 rounded-2xl border border-slate-200 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-800 p-6 text-white">
        ...
        <p className="mt-2 text-slate-300">{format(new Date(event.startsAt), "dd 'de' MMMM 'de' yyyy, HH:mm", { locale: ptBR })}</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        <Card className="border-slate-200">
          ...
          <CardContent>
            {session ? (
              <CheckoutForm action={createCheckoutAction} options={options} />
            ) : (
        ...
        <Card className="border-slate-200">
          <CardHeader>
            ...
            <CardDescription>Baseado nos ticket types e lotes ativos.</CardDescription>
          </CardHeader>
